...
#define TIMER0_RESP_FUNC PostTemplateHSM // 58 seconds count down
#define TIMER1_RESP_FUNC PostTemplateHSM // 3 seconds shaking step motor
#define TIMER2_RESP_FUNC PostTemplateHSM // 5 seconds celebration/fail
#define TIMER3_RESP_FUNC PostTemplateHSM // 10 seconds wathching dog for jam
#define TIMER4_RESP_FUNC PostTemplateHSM // 5 seconds raise ball
#define TIMER5_RESP_FUNC PostTemplateHSM // protection timer
#define TIMER6_RESP_FUNC PostTimerService // IR 50hz
#define TIMER7_RESP_FUNC TIMER_UNUSED //
#define TIMER8_RESP_FUNC PostTimerService // power & floating 4hz
#define TIMER9_RESP_FUNC PostTimerService // 12.5hz call for nothing
...
#define SERV_0_QUEUE_SIZE 31

/****************************************************************************/
// These are the definitions for Service 1
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "ES_TimerService.h"
// the name of the Init function
#define SERV_1_INIT InitTimerService
// the name of the run function
#define SERV_1_RUN RunTimerService
