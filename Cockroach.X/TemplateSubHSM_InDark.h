...
#ifndef SUB_TEMPLATE_HSM_INDARK_H  // <- This should be changed to your own guard on both
#define SUB_TEMPLATE_HSM_INDARK_H  //    of these lines
...
#endif /* SUB_TEMPLATE_HSM_INDARK_H */
