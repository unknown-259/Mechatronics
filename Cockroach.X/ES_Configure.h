...
#define EVENT_CHECK_LIST  TemplateCheckBattery, CheckLightToDark, CheckDarkToLight
...
#define TIMER0_RESP_FUNC PostTemplateService // Replace TIMER_UNUSED with e.g.,PostTemplateService 
